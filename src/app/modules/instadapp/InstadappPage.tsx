...
const InstadappWrapper: FC = () => {
  ...
  return (
    <>
      <PageTitle children={'InstaDapp Dashboard'} />
        ...
        >
          <div className='d-flex flex-column flex-column-fluid text-center p-10 py-lg-20'>
            ...
            <div className='fw-bold fs-3 text-gray-400 mb-15'>
              Usually Work on it in my freetime! <br /> InstaDapp smart wallet with multichain
              Support
            </div>
